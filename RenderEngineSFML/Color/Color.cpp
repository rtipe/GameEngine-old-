...
Color::Color(const Color &color)
    : _r(color.getR()), _g(color.getG()), _b(color.getB()), _a(color.getA()) {}

Color::Color(int r, int g, int b) : _r(r), _g(g), _b(b), _a(255) {}

Color::Color(int r, int g, int b, int a) : _r(r), _g(g), _b(b), _a(a) {}

int Color::getR() const { return this->_r; }

int Color::getG() const { return this->_g; }

int Color::getB() const { return this->_b; }

int Color::getA() const { return this->_a; }
