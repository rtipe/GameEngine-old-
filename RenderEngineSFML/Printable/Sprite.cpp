...
const std::string &Sprite::getTypeName() const { return this->_type; }

const Vector3f &Sprite::getPosition() const { return this->_position; }

const Vector2f &Sprite::getScale() const { return this->_scale; }

const float Sprite::getRotation() const { return this->_rotation; }
