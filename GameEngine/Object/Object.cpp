...
Object::Object(Object &object)
  ...
  if (object.hasPrintable()) {
    if (object.getPrintable().getTypeName() == "sprite") {
      this->_printable = std::make_unique<Render::Sprite>(
          dynamic_cast<Render::Sprite &>(object.getPrintable()));
    }
    if (object.getPrintable().getTypeName() == "text") {
      this->_printable = std::make_unique<Render::Text>(
          dynamic_cast<Render::Text &>(object.getPrintable()));
    }
  }
}
...
const std::string &Object::getName() const { return this->_name; }
...
bool Object::isEnabled() const { return this->_isEnable; }

const Transform &Object::getTransform() const { return this->_transform; }

Transform &Object::getTransform() { return this->_transform; }

const ObjectManager &Object::getChildren() const { return this->_children; }

ObjectManager &Object::getChildren() { return this->_children; }

const Scene &Object::getScene() const { return this->_scene; }

Scene &Object::getScene() { return this->_scene; }

const ScriptManager &Object::getScriptManager() const {
  return this->_scriptManager;
}

ScriptManager &Object::getScriptManager() { return this->_scriptManager; }

const Movement &Object::getMovement() const { return this->_movement; }

Movement &Object::getMovement() { return this->_movement; }

const Collision &Object::getCollision() const { return this->_collision; }

Collision &Object::getCollision() { return this->_collision; }

const std::string &Object::getLayer() const { return this->_layer; }
...
Render::IPrintable &Object::getPrintable() { return *this->_printable; }
...
void Object::setPrintable(const Json::Value &value) {
  ...
  if (type == "sprite") {
    ...
    std::unique_ptr<Render::Sprite> sprite = std::make_unique<Render::Sprite>(
        this->_scene.getAssetManager().getTexture(textureName));
  ...
  if (type == "text") {
    ...
    std::unique_ptr<Render::Text> text = std::make_unique<Render::Text>(
        this->_scene.getAssetManager().getFont(fontName));
